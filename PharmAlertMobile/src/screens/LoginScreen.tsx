...
const DEFAULT_URL = 'https://8ac5f490a17eba37-102-64-167-178.serveousercontent.com/api/v1';
      ...
      Animated.loop(
        Animated.sequence([
          Animated.timing(anim, {
            toValue: { x: toX, y: toY }, duration,
            easing: Easing.inOut(Easing.sin), useNativeDriver: true,
          }),
          Animated.timing(anim, {
            toValue: { x: 0, y: 0 }, duration,
            easing: Easing.inOut(Easing.sin), useNativeDriver: true,
          }),
        ])
      );

    const b1 = createFloat(blob1Anim, 25, 35, 6000);
    const b2 = createFloat(blob2Anim, -20, 30, 8000);
    const b3 = createFloat(blob3Anim, 15, -25, 7000);
      ...
      >
        ...
        >
          ...
          <View style={[styles.serverBox, {
            ...
            <Text style={[styles.serverLabel, { color: theme.dark ? '#60A5FA' : '#3B82F6' }]}>
              Serveur
            </Text>
            {editingUrl ? (
              <View style={styles.serverEditRow}>
                <TextInput
                  ...
                  placeholder="https://votre-serveur.com/api/v1"
                  autoCapitalize="none"
                  keyboardType="url"
...
const styles = StyleSheet.create({
  ...
  blob1: { width: 280, height: 280, backgroundColor: '#34D399', top: -60, left: -80 },
  blob2: { width: 200, height: 200, backgroundColor: '#60A5FA', bottom: 80, right: -60 },
  blob3: { width: 160, height: 160, backgroundColor: '#818CF8', top: height * 0.3, right: -40 },
  ...
  serverBox: { borderRadius: 12, padding: 14, marginBottom: 24, borderWidth: 1 },
  ...
  serverUrlText: { fontSize: 12, fontFamily: Platform.OS === 'ios' ? 'Courier' : 'monospace', flex: 1 },
  serverEditIcon: { fontSize: 14, marginLeft: 8 },
  serverEditRow: { flexDirection: 'row', alignItems: 'center' },
  serverInput: {
    flex: 1, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8,
    fontSize: 12, borderWidth: 1, fontFamily: Platform.OS === 'ios' ? 'Courier' : 'monospace',
  },
  serverSaveBtn: {
    marginLeft: 8, backgroundColor: '#1E40AF', borderRadius: 8,
    width: 36, height: 36, alignItems: 'center', justifyContent: 'center',
  },
  serverSaveBtnText: { color: '#fff', fontSize: 16, fontWeight: '700' },
  serverCancelBtn: {
    marginLeft: 6, backgroundColor: '#E5E7EB', borderRadius: 8,
    width: 36, height: 36, alignItems: 'center', justifyContent: 'center',
  },
